...
class AppSettingsService {
  ...
  static const _mindTrickIntroShownKey = 'mind_trick_intro_shown';
  ...
  Future<bool> hasMindTrickIntroShown() async {
    final prefs = await _prefs;
    return prefs.getBool(_mindTrickIntroShownKey) ?? false;
  }

  Future<void> setMindTrickIntroShown(bool value) async {
    final prefs = await _prefs;
    await prefs.setBool(_mindTrickIntroShownKey, value);
  }
}
